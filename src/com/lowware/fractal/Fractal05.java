...
public class Fractal05 extends Fractal
{
     /**
    ...
    public String getFractalName() {
        ...
        b.append("Fractal05 ");
        b.append("Z(n+1) = Z(n)^2 with IM warped by Z(n)^2 + c, over " + getMaxIterations() + " iterations at");
        b.append(" ");
    ...
    public Fractal05(FractalPanel panel) {
        super(panel);
    }
}
