...
public class Fractal03 extends Fractal
{
     /**
    ...
    public String getFractalName() {
        ...
        b.append("Fractal03 ");
        b.append("Z(n+1) = Z(n)^4 + c with algebra mistake, over " + getMaxIterations() + " iterations at");
        b.append(" ");
    ...
    public Fractal03(FractalPanel panel) {
        super(panel);
    }
}
