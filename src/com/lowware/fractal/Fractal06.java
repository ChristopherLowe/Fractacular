...
public class Fractal06 extends Fractal
{
     /**
    ...
    public String getFractalName() {
        ...
        b.append("Fractal06 ");
        b.append("Z(n+1) = Z(n)^3 + c with RE and IM algebra mistake, over " + getMaxIterations() + " iterations at");
        b.append(" ");
    ...
    public Fractal06(FractalPanel panel) {
        super(panel);
    }
}
